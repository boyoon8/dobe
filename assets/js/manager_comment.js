if (typeof(COMMENT_JS) === 'undefined') {
    ...
    function view_comment(id, post_id, page, opt, message) {
        ...
        var comment_url = cb_manager_url + '/board/comment_list/lists/' + post_id + '?page=' + page;
    ...
    function view_comment_password(cmt_id, post_id) {
        var comment_url = cb_manager_url + '/board/comment_list/password/' + cmt_id + '/' + post_id;
    ...
    function add_comment(f, post_id) {
        ...
        $.ajax({
            url : cb_manager_url + '/board/comment_write/update',
            type : 'POST',
            cache : false,
