...
<div class="board">
    <!-- <h3><?php echo html_escape(element('board_name', element('board', $view))); ?> 쓰기</h3> -->
    <?php
    ...
    ?>
        ...
        <div class="form-horizontal box-table">
            ...
            <?php if (element('can_post_notice', element('post', $view)) OR element('can_post_secret', element('post', $view)) OR element('can_post_receive_email', element('post', $view))) { ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php } ?>
                        <?php if (element('can_post_hotline', element('post', $view))) { ?>
                            <label class="checkbox-inline" for="post_notice_3">
                                <input type="checkbox" name="post_notice" id="post_notice_3" value="3" <?php echo set_checkbox('post_notice', '3', (element('post_notice', element('post', $view)) === '3' ? true : false)); ?>  /> Hotline
                            </label>
                        <?php } ?>
            ...
            <div class="border_button text-center mt20">
                <button type="button" class="btn btn-default btn-sm" onClick="javascript:view_post('detail_view','<?php echo element('post_id', element('post', $view))?>','','');">취소</button>
