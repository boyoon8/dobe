                    ...
                    <table class="table table-bordered table-hover table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-inline">
                                        <select class="form-control" name="layout_manager" id="layout_manager">
                                            <?php echo element('layout_manager_option', element('data', $view)); ?>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-inline">
                                        <select class="form-control" name="sidebar_manager" id="sidebar_manager">
                                            <option value="">기본설정따름</option>
                                            <option value="1" <?php echo set_select('sidebar_manager', '1', (element('sidebar_manager', element('data', $view)) === '1' ? true : false)); ?> >사용</option>
                                            <option value="2" <?php echo set_select('sidebar_manager', '2', (element('sidebar_manager', element('data', $view)) === '2' ? true : false)); ?> >사용하지않음</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-inline">manager/
                                        <select class="form-control" name="skin_manager" id="skin_manager">
                                            <?php echo element('skin_manager_option', element('data', $view)); ?>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-inline">
                                        <select class="form-control" name="mobile_layout_manager" id="mobile_layout_manager">
                                            <?php echo element('mobile_layout_manager_option', element('data', $view)); ?>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-inline">
                                        <select class="form-control" name="mobile_sidebar_manager" id="mobile_sidebar_manager">
                                            <option value="">기본설정따름</option>
                                            <option value="1" <?php echo set_select('mobile_sidebar_manager', '1', (element('mobile_sidebar_manager', element('data', $view)) === '1' ? true : false)); ?> >사용</option>
                                            <option value="2" <?php echo set_select('mobile_sidebar_manager', '2', (element('mobile_sidebar_manager', element('data', $view)) === '2' ? true : false)); ?> >사용하지않음</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-inline">manager/
                                        <select class="form-control" name="mobile_skin_manager" id="mobile_skin_manager">
                                            <?php echo element('mobile_skin_manager_option', element('data', $view)); ?>
                                        </select>
                                    </div>
                                </td>
                                <td><button type="button" onClick="open_preview('manager')" class="btn btn-xs btn-success">미리보기</button></td>
                            </tr>
                            <tr>
                                <th>게시판</th>
                                <td>
