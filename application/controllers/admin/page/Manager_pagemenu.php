 ...
 */
class Manager_pagemenu extends CB_Controller
{
     ...
     * 페이지 이동시 필요한 정보입니다
     */
    public $pagedir = 'page/manager_pagemenu';

    /**
     * 모델을 로딩합니다
     */
    protected $models = array('Manager_menu');

    /**
     * 이 컨트롤러의 메인 모델 이름입니다
     */
    protected $modelname = 'Manager_menu_model';
    ...
    public function index()
    {
        ...
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_page_manager_pagemenu_index';
        ...
        if ($this->form_validation->run() === false) {
            ...
            redirect(admin_url('page/manager_pagemenu'), 'refresh');
        }
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_page_manager_pagemenu_listupdate';
        $this->load->event($eventname);
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_page_manager_pagemenu_listdelete';
        $this->load->event($eventname);
    ...
    {
        $this->cache->delete('manager_pagemenu-mobile');
        $this->cache->delete('manager_pagemenu-desktop');
    }
}
